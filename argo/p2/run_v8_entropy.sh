...
run "fedwavg-entropy" stage2-entropy.yaml \
    -p job=stage2-p2-v8-fedwavg-entropy-0 -p selection=entropy \
...
run "fedpod-entropy" stage2-entropy.yaml \
    -p job=stage2-p2-v8-fedpod-entropy-0 -p selection=entropy \
...
run "fedpid-entropy" stage2-entropy.yaml \
    -p job=stage2-p2-v8-fedpid-entropy-0 -p selection=entropy \
...
run "fedbn-entropy" stage2-entropy.yaml \
    -p job=stage2-p2-v8-fedbn-entropy-0 -p selection=entropy \
